...
export default function WitnessesCreate({ clientId, auth }) {
    ...
    return (
        <AppLayout title="Add Witness" auth={auth}>
            <Head title="Add Witness" />
            <div>
                <div className="mb-6">
                    <Link
                ...
                <div className="bg-white shadow rounded-lg">
                    <div className="px-4 py-5 sm:p-6">
                        <h2 className="text-xl font-semibold text-gray-900 mb-6">Add Witness</h2>
                        ...
                        <form onSubmit={submit}>
                            ...
                            <div className="mt-6 flex items-center justify-end space-x-3">
                                ...
                                >
                                    {processing ? 'Saving...' : 'Save Witness'}
                                </button>
                            </div>
                        </form>
                    </div>
