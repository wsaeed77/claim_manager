...
export default function PartnersEdit({ partner, auth }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(`/partner/${partner.id}/edit`);
    };

    return (
        <AppLayout title="Edit Partner" auth={auth}>
            ...
            <div>
                ...
                <div className="bg-white shadow rounded-lg">
                    <div className="px-4 py-5 sm:p-6">
                        <h2 className="text-xl font-semibold text-gray-900 mb-6">Edit Partner</h2>
